...
import xengine.IRenderer;
import xengine.RenderManager;
import xengine.RendererGL;
import xengine.VRML97Loader;
import xfaceapp.ModelCamera;
import xfaceapp.ModelCamera.kMODE;
...
//		}
	...
	public void init(GLAutoDrawable p_autoDrawable)
	{
		...
		m_pApp.onLoadFDP("alice.fdp", "C:\\code_space\\java\\eclipse\\XFace\\trunk\\face\\", m_gl);
		...
		m_pApp.onLoadPHO("C:\\code_space\\java\\eclipse\\XFace\\trunk\\face\\say-suffering-angina.pho", "english");
